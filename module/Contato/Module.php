    ...
    return array(
        'factories' => array(
            'ContatoTableGateway' => function ($sm) {
                ...
                $adapter = $sm->get('AdapterDb');  // class AdapterDb contida em global.php
                
                
                // configurar ResultSet com nosso model Contato (Contato.php)
...
{
    return array(
        'factories' => array(    // REGISTRANDO O CONTROLLER PLUGIN cache
            'cache' => function($sm) {
