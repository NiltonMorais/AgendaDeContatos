...
class ContatoForm extends Form
{
    ...
    public function __construct($name = null)
    {
        ...
        // elemento do tipo text para nome
        $this->add(array(
        ...
        // elemento do tipo text para telefone principal
        $this->add(
        ...
        // elemento do tipo text para telefone secundario
        $this->add(array(
            ...
            'attributes' => array(
                ...
                'placeholder'   => 'Digite o telefone secundário (opcional)',
            ),
        ));
                ...
                (new Element\Captcha())
                        ...
                        ->setOptions(array(
                            'captcha' => (new Captcha\Figlet(array(
                                'wordLen'       => 4,      # quantidade de caracteres para o nosso captcha
                        ...
                        ->setAttributes([
                            'class'         => 'form-control',
                            'id'            => 'inputCaptcha',
                            'placeholder'   => 'Digite a palavra acima para proseguir',
                        ])
        );
