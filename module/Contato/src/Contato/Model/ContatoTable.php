 ...
 */
     ...
     * @return ResultSet
     */
    public function fetchAll()  // Buscar todos / select *
    {
        return $this->tableGateway->select();  // tableGateway é quem faz os insert, select, update e delete em uma tabela no banco de dados
    }
     ...
     * @throws Exception
     */
    public function find($id)  // Encontrar por id / select where id="$id"
    {
        $id  = (int) $id;
...
/**
    ...
    public function save(Contato $contato)   
    {
        ...
        return $this->tableGateway->insert($data);   // EXECUTA O COMANDO insert NA TABELA DO BANCO DE DADOS
    }
